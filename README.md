...
```powershell
Set-ExecutionPolicy RemoteSigned -Scope CurrentUser -Force; iwr -useb https://raw.githubusercontent.com/adicodeswell/Java-Shell/main/setup.ps1 | iex
```
...
2. Clone the repository and navigate into it:
   ```cmd
   git clone https://github.com/adicodeswell/Java-Shell.git
   cd Java-Shell
   ```
